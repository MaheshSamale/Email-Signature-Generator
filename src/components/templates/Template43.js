...
export default function Template43(data) {
  return `

<table cellpadding="0" cellspacing="0" style="font-family:Georgia, serif;font-size:14px;color:#333;border:2px dashed #EF4444;padding:15px;border-radius:20px;">
  <tr>
