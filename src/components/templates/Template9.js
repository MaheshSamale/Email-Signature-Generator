...
<table cellpadding="0" cellspacing="0" style="font-family:Georgia, serif;font-size:14px;color:#333;">
  <tr>
    <td style="padding-right:15px;text-align:right;">
      ...
      ${data.email ? `<div style="margin-bottom:8px;"><a href="mailto:${data.email}" style="color:#64748B;text-decoration:none;font-weight:600;">${data.email}</a></div>` : ''}
    ...
    ${data.photo ? `<td style="padding-left:15px;border-left:1px solid #64748B;"><img src="${data.photo}" width="90" style="border-radius:8px;display:block;"/></td>` : ""}
  </tr>
</table>`;
}
