...
export default function Template59(data) {
  return `

<table cellpadding="0" cellspacing="0" style="font-family:"Courier New", Courier, monospace;font-size:14px;color:#333;border:3px dotted #64748B;padding:15px;border-radius:20px;">
  <tr>
    ...
    <td>
      ...
      ${data.email ? `<div style="margin-bottom:4px;"><a href="mailto:${data.email}" style="color:#64748B;text-decoration:none;font-weight:600;">${data.email}</a></div>` : ''}
