...
<table cellpadding="0" cellspacing="0" style="font-family:Helvetica, sans-serif;font-size:14px;color:#333;text-align:center;">
  <tr>
    <td style="padding-bottom:15px;border-bottom:3px dotted #4F46E5;">
      ...
      <div style="font-size:14px;">${data.title} ${data.company ? `<strong style="color:#4F46E5">@ ${data.company}</strong>` : ''}</div>
    </td>
  </tr>
  <tr>
    <td style="padding-top:10px;">
      ${data.email ? `<div style="margin-bottom:4px;"><a href="mailto:${data.email}" style="color:#4F46E5;text-decoration:none;font-weight:bold;">${data.email}</a></div>` : ''}
