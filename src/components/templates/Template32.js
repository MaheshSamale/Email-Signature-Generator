...
export default function Template32(data) {
  return `

<table cellpadding="0" cellspacing="0" width="450" style="font-family:Helvetica, sans-serif;font-size:14px;color:#333;table-layout:fixed;">
  <tr>
    ...
    <td width="5%" style="border-left:3px dotted #F59E0B;"></td>
    <td width="60%" style="vertical-align:top;padding-left:10px;">
      ${data.company ? `<strong style="color:#F59E0B;font-size:15px;">${data.company}</strong>` : ''}
