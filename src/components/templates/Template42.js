...
export default function Template42(data) {
  return `
...
<table cellpadding="0" cellspacing="0" style="font-family:Helvetica, sans-serif;font-size:14px;color:#333;">
  <tr>
    ...
    ${data.photo ? `<td style="padding-left:15px;border-left:1px solid #F59E0B;"><img src="${data.photo}" width="90" style="border-radius:0;display:block;"/></td>` : ""}
  </tr>
</table>`;
}
