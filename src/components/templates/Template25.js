...
export default function Template25(data) {
  return `

<table cellpadding="0" cellspacing="0" style="font-family:Arial, sans-serif;font-size:14px;color:#333;">
  <tr>
    ${data.photo ? `<td style="padding-right:15px;border-right:2px dashed #8B5CF6;"><img src="${data.photo}" width="90" style="border-radius:8px;display:block;"/></td>` : ""}
