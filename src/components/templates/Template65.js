...
export default function Template65(data) {
  return `
...
<table cellpadding="0" cellspacing="0" style="font-family:"Courier New", Courier, monospace;font-size:14px;color:#333;">
  <tr>
    <td style="padding-right:15px;text-align:right;">
      ...
      ${data.email ? `<div style="margin-bottom:8px;"><a href="mailto:${data.email}" style="color:#8B5CF6;text-decoration:none;font-weight:600;">${data.email}</a></div>` : ''}
    ...
    ${data.photo ? `<td style="padding-left:15px;border-left:3px dotted #8B5CF6;"><img src="${data.photo}" width="90" style="border-radius:8px;display:block;"/></td>` : ""}
  </tr>
</table>`;
}
