...
export default function Template66(data) {
  return `

<table cellpadding="0" cellspacing="0" style="font-family:Arial, sans-serif;font-size:14px;color:#333;border:1px solid #EC4899;padding:15px;border-radius:0;">
  <tr>
    ...
    <td>
      ...
      ${data.email ? `<div style="margin-bottom:4px;"><a href="mailto:${data.email}" style="color:#EC4899;text-decoration:none;font-weight:600;">${data.email}</a></div>` : ''}
